        ...
        <div className="flex justify-between items-center w-full">
          ...
          <div className="user-info flex items-center justify-end w-full space-x-2 z-10 ">
            ...
            <button
              ...
              type="button"
              className="w-[52px] h-[52px] dark:bg-white bg-dark-gray border border-pink rounded-full flex justify-center items-center"
            >
            ...
            {/* balance */}
            <div className="flex user-balance cursor-pointer w-[150px] h-[48px]  items-center rounded-full relative  bg-purple pr-1.5 pl-4">
              <div
