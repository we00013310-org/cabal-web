      ...
      <div className="flex flex-col justify-between w-full h-full">
        ...
        <div className="thumbnail-area w-full">
          <div className="w-full h-[236px]   rounded-xl overflow-hidden relative">
            ...
            <div className="product-two-options flex justify-between mb-5 w-full top-0 z-10 p-6 absolute">
            ...
            {hidden && (
              <div className="flex justify-center top-0 w-full h-full items-center p-6  z-10 absolute">
                <svg
                  width="108"
                  height="91"
                  viewBox="0 0 108 91"
