      ...
      <div className="terms-condition-wrappr w-full">
        ...
        <div className="mb-8">
          ...
          <p className="text-base text-thin-light-gray leading-[28px] ">
            ...
            from a dedicated website(&quot;Sale&quot;). The web address of this
            website will be given at the time of the mint. The NFT acquisition
            does not confer any rights on the Company or in the future
            development.
          </p>
        </div>
        <div className="mb-8">
