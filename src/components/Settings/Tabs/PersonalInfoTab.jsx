...
PersonalInfoTab.propTypes = {
  ...
  frstNmeHndlr: PropTypes.func,
  lstNmeHndlr: PropTypes.func,
  dscrphn: PropTypes.string,
  profileImg: PropTypes.string,
  coverImg: PropTypes.string,
  profileImgInput: PropTypes.object,
  browseProfileImg: PropTypes.func,
  profileImgChangHandler: PropTypes.func,
  coverImgInput: PropTypes.object,
  browseCoverImg: PropTypes.func,
  coverImgChangHandler: PropTypes.func,
};
