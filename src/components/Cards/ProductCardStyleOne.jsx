    ...
    <div className="card-style-one flex flex-col justify-between w-full h-[387px] bg-white dark:bg-dark-white    p-3 pb rounded-2xl">
      <div className="content">
        ...
        <div className="w-full h-40">
          {/* thumbnail image */}
          <div className="thumbnail w-full h-full rounded-xl relative overflow-hidden">
            <div className="rounded-xl w-full h-full relative z-0 overflow-hidden">
              <LocalImg
                className="w-full h-full"
                alt="user"
                url={`${datas.thumbnil}`}
              />
              <div className="product-options flex justify-between  z-10 absolute top-[18px] px-[18px] w-full">
                <span
              ...
              {hidden && (
                <div className="flex justify-center absolute w-full h-full top-0 items-center z-10">
                  <svg
                    width="108"
                    height="91"
                    viewBox="0 0 108 91"
