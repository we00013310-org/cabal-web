...
ProductUploadField.propTypes = {
  datas: PropTypes.object,
  cpt: PropTypes.string,
  inh: PropTypes.string,
  linkh: PropTypes.string,
  dscrphn: PropTypes.string,
  priceHndlr: PropTypes.func,
  roltsHndlr: PropTypes.func,
  keyHndlr: PropTypes.func,
  valueHndlr: PropTypes.func,
  unlckPrchesHndlr: PropTypes.func,
};
